...
RESULTS_DIR=$CODEDIR/results/pretrain_base_adamw_8node_gns_autoamp_precond
...
CMD+=" $ALL_REDUCE_POST_ACCUMULATION"
CMD+=" $ALL_REDUCE_POST_ACCUMULATION_FP16"
#CMD+=" --do_train --phase2 --resume_from_checkpoint --phase1_end_step=$train_steps" FIXME: hardcoded for the moment
CMD+=" --do_train --phase2 --resume_from_checkpoint --phase1_end_step=4791"
CMD+=" --json-summary ${RESULTS_DIR}/dllogger.json "
CMD+=" --use_preconditioner "
