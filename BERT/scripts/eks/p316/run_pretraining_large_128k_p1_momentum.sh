...
# 128K batch settings for 256 16GB GPUs (32 P3.16xlarge)
...
# seed=${12:-72337}
seed=${12:-1217}
job_name=${13:-"bert_large_adamw_pretraining_128k_momentum_2"}
...
AUTOSCALER_CONFIG=/gradstats/BERT/autoscaler_momentum.yaml
...
RESULTS_DIR=/shared/export/BERT/4x_large_32node_128k_momentum_2/
...
CMD+=" --label bert_training_large_128K_32node_momentum_2 "
