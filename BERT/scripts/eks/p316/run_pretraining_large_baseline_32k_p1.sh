...
# 32K batch settings for 256 16GB GPUs (32 P3.16xlarge)
...
seed=${12:-72337}
job_name=${13:-"bert_large_adamw_pretraining_baseline"}
...
AUTOSCALER_CONFIG=/gradstats/BERT/autoscaler.yaml
...
RESULTS_DIR=/shared/export/BERT/1x_large_32node_fixed/
...
CMD+=" --label bert_training_large_32K_32node_fixed "
