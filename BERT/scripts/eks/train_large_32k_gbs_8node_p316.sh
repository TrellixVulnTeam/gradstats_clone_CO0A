...
# 32K batch settings for 64 GPUs - settings are same as 32K bs except for scale and batch size
...
RESULTS_DIR=/shared/export/BERT/bert_large_32k_8node_p316/
...
CMD+=" --label bert_training_large_32k_8node "
