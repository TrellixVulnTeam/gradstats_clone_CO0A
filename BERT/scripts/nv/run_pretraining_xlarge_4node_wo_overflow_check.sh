...
seed=${12:-12439}
job_name=${13:-"bert_xlarge_lamb_pretraining_wo_overflow_cheks_fp32"}
...
BERT_CONFIG=/fsx/code/gradstats/BERT/bert_config_xlarge_height.json
DATASET2=books_wiki_en_corpus # change this for other datasets
...
CMD=" $CODEDIR/run_pretraining_nv_orig.py"
