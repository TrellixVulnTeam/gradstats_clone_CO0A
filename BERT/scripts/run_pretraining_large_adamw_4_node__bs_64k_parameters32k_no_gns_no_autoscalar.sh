...
LABEL=pretrain_large_4node_adam_64kbs_32k_hps
...
TB_DIR2=$RESULTS_DIR/tensorboard_phase2
CMD+=" --log_dir ${TB_DIR} "
CMD+=" --bucket ${BUCKET} "
CMD+=" --label ${LABEL} "
