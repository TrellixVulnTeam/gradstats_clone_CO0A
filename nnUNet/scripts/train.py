...
if __name__ == "__main__":
    ...
    cmd += f"--learning_rate 0.001 --num_workers 12 --batch_size 64 --optimizer adam --enable_adascale --lr_scale 6.0 "
    # cmd += f"--learning_rate 0.00245 --num_workers 12 --batch_size 384 --optimizer adam "
