...
# whether to decode prediction bbox
_C.MODEL.ROI_BOX_HEAD.DECODE = False
_C.MODEL.ROI_BOX_HEAD.LOSS = "SmoothL1Loss"
...
_C.SOLVER.GRADIENT_CLIP_NORM = 0.0
_C.SOLVER.GRADIENT_CLIP_VAL = 0.0
